...
WSGI_APPLICATION = 'getmebuddy.wsgi.application'
ASGI_APPLICATION = 'getmebuddy.asgi.application'
...
# Media files
if 'AWS_ACCESS_KEY_ID' in os.environ and os.environ.get('AWS_ACCESS_KEY_ID'):
    # AWS S3 Settings
...
if 'FIREBASE_TYPE' in os.environ and os.environ.get('FIREBASE_TYPE'):
